...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserUploadUrl = `${APP_UPLOAD}/posts/video`;// api upload image.
	// config.filebrowserImageUploadUrl = '/posts/image';// api upload image.
	config.fileUploadURL = `${APP_UPLOAD}/image-file`;// api upload file.
	config.uploadUrl = `${APP_UPLOAD}/image-clipboard`;
